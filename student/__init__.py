...
URL_PAGE = URL_CAS_BASE + '/user/login'
URL_VERCODE = URL_CAS_BASE + '/user/vercode'
URL_LOGIN_FLAVORING = URL_CAS_BASE + '/user/checkInitVercode'
URL_COOKIE = URL_VPN_BASE + '/wengine-vpn/cookie?method=get&host=user.hfut.edu.cn&scheme=http&path=/user/login'
URL_CHECK = URL_CAS_BASE + '/user/policy/checkUserIdenty'
URL_LOGIN = URL_CAS_BASE + '/user/login?service=https%3A%2F%2F' + VPN_DOMAIN + '%2Flogin%3Fcas_login%3Dtrue'
URL_VPN_LOGIN = URL_CAS_BASE + '/user/login?service=https%3A%2F%2F' + VPN_DOMAIN + '%2Flogin%3Fcas_login%3Dtrue'
URL_GET_OC = URL_CAS_BASE + '/user/oauth2.0/authorize?response_type=code&client_id=BsHfutEduPortal&redirect_uri=https://one.hfut.edu.cn/Login'
URL_VERIFY_OC = URL_ONE_BASE + '/Login'
URL_GET_AT = URL_ONE_BASE + '/api/auth/oauth/getToken'
URL_VERIFY_AT = URL_ONE_BASE + '/user/bosssoft/checkToken'
